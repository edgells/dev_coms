this.seajs = {
    ...
    define("newweb/common/ZeroClipboard", [], function (e, t) {
        !function (e, t) {
            "use strict";
            var n, r, i, o = e, a = o.document, s = o.navigator, l = o.setTimeout, c = o.clearTimeout,
                u = o.setInterval, d = o.clearInterval, f = o.getComputedStyle, p = o.encodeURIComponent,
                h = o.ActiveXObject, m = o.Error, g = o.Number.parseInt || o.parseInt,
                v = o.Number.parseFloat || o.parseFloat, y = o.Number.isNaN || o.isNaN, b = o.Date.now,
                x = o.Object.keys, w = o.Object.prototype.hasOwnProperty, T = o.Array.prototype.slice, _ = function () {
                    var e = function (e) {
                        return e
                    };
                ...
                I = "html" === a.documentElement.nodeName, H = {
                    bridge: null,
                    version: "0.0.0",
                    pluginType: "unknown",
                    sandboxed: null,
                ...
                Y = new RegExp("^flash-(" + V.map(function (e) {
                    ...
                    var t = null;
                    return (!1 === M || e && "error" === e.type && e.name && -1 !== X.indexOf(e.name)) && (t = !1),
                        t
                }, Te = function (e) {
    ...
    define("newweb/common/download", ["./utils", "./log"], function (e, t) {
        ...
        var r = e("./jquery-1.7")
            ...
            r.ajax({
                type: "GET",
                url: "https://gorgon.youdao.com/gorgon/request.s",
                data: {
                ...
                e.fn.ajaxSubmit = function (t, n, i, s) {
                    ...
                    function c(n) {
                        ...
                        var D, O, L, F = 50, R = e.parseXML || function (e, t) {
                            ...
                            "string" == typeof a && (("json" === n || !n) && i.indexOf("json") >= 0 ? a = q(a) : ("script" === n || !n) && i.indexOf("javascript") >= 0 && e.globalEval(a)),
                                a
                        };
                        return k
                    }
                ...
                data: function (e, n, r, i) {
                    if (R.acceptData(e)) {
                        ...
                        var o, a, s, l = "string" == typeof n, c = e.nodeType, u = c ? R.cache : e,
                            d = c ? e[R.expando] : e[R.expando] && R.expando, f = "events" === n;
            ...
            R.event = {
                ...
                dispatch: function (n) {
                    ...
                    var r, i, o, a, s, l, c, u, d, f, p = (R._data(this, "events") || {})[n.type] || [],
                        ...
                        v = (R.event.special[n.type] || {}).handle, y = [];
                    if (m[0] = n,
                ...
                R.extend({
                    ...
                    style: function (e, n, r, i) {
                        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                            ...
                            if (!("string" == (a = typeof r) && (o = qe.exec(r)) && (r = +(o[1] + 1) * +o[2] + parseFloat(R.css(e, n)),
                                a = "number"),
                ...
                R.each(["height", "width"], function (e, t) {
                    R.cssHooks[t] = {
                        get: function (e, n, r) {
                            var i;
                            if (n)
                                return 0 !== e.offsetWidth ? y(e, t, r) : (R.swap(e, Me, function () {
                                    i = y(e, t, r)
                                }),
                                    i)
                        },
                ...
                R.extend({
                    ...
                    ajax: function (e, n) {
                        ...
                        "object" == typeof e && (n = e,
                            e = t),
                            n = n || {};
                        var i, o, a, s, l, c, u, d, f = R.ajaxSetup({}, n), p = f.context || f,
                            h = p !== f && (p.nodeType || p instanceof R) ? R(p) : R.event, m = R.Deferred(),
                            g = R.Callbacks("once memory"), v = f.statusCode || {}, y = {}, b = {}, w = 0, T = {
                                readyState: 0,
            ...
            R.ajaxSetup({
                ...
                R.ajaxPrefilter("json jsonp", function (t, n, r) {
                    ...
                    if ("jsonp" === t.dataTypes[0] || !1 !== t.jsonp && (lt.test(t.url) || i && lt.test(t.data))) {
                        var o,
                            a = t.jsonpCallback = R.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
            ...
            R.fn.extend({
                ...
                animate: function (e, t, n, r) {
                    function i() {
                        ...
                        var t, n, r, i, a, s, l, c, u, d = R.extend({}, o), f = 1 === this.nodeType,
